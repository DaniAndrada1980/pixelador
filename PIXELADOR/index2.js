      ...
      [
        function (e, t, i) {
          ...
          ;(t.__esModule = !0),
            (t.kebabCase =
              t.highlight =
              t.isValueInArrayOfObjects =
              t.debounce =
              t.putContent =
              t.ensureElementInView =
              t.hasClassInTree =
                void 0),
          ...
          var n = i(0),
            ...
            i =
              ...
              (s.prototype.deselect = function () {
                this.singleSelected &&
                  (!this.main.config.allowDeselect ||
                  '' === this.main.selected()
                ...
                return (
                  ...
                  s.mandatory ||
                    ...
                    (t.onclick = function (e) {
                      ...
                      var t = !1
                      if (
                        (a.main.beforeOnChange || (t = !0),
                        a.main.beforeOnChange)
                      ) {
                        for (
              ...
              (s.prototype.highlightUp = function () {
                ...
                if (e)
                  for (
                    t = e.previousSibling;
                    null !== t &&
                    t.classList.contains(this.main.config.disabled);
              ...
              (s.prototype.highlightDown = function () {
                ...
                if (t)
                  for (
                    i = t.nextSibling;
                    null !== i &&
                    i.classList.contains(this.main.config.disabled);
                    ...
                    if (e.hasOwnProperty('label')) {
                      ...
                      i.classList.add(r.main.config.optgroupLabel),
                        r.main.config.selectByGroup &&
                          ...
                          i.classList.add(
                            r.main.config.optgroupLabelSelectable
                          ),
                        (i.innerHTML = t.label),
                        s.appendChild(i)
                      t = t.options
                        ...
                        r.main.config.selectByGroup &&
                          ...
                          i.addEventListener('click', function (e) {
                            ...
                            for (var t = 0, i = s.children; t < i.length; t++) {
                              var n = i[t]
                              ;-1 !==
                                n.className.indexOf(a.main.config.option) &&
                                n.click()
                            }
                          }))
                      }
